...
class TestResourceAPIContract:
    ...
    async def test_resource_api_response_parsing(self, api_client, sample_results, mock_resource_api_response):
        ...
        with patch.object(api_client, '_make_request', new_callable=AsyncMock) as mock_request:
            mock_request.return_value = mock_resource_api_response
    ...
    @pytest.mark.contract
    async def test_resource_api_rate_limiting(self, api_client, sample_results):
    ...
    @pytest.mark.contract
    async def test_resource_api_authentication_error(self, api_client, sample_results):
